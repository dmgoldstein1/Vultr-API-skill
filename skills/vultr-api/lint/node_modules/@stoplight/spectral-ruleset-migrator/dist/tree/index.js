...
class Tree {
    ...
    resolveModule(identifier, ctx, kind) {
        ...
        if (path.isURL(identifier) || path.isAbsolute(identifier)) {
            ...
            else if (typeof requireResolve_1.default === 'function') {
                resolved = (_a = (0, requireResolve_1.default)(identifier, { paths: [ctx.cwd] })) !== null && _a !== void 0 ? _a : path.join(ctx.cwd, identifier);
            }
            else {
